...
<div class="bg-gray-200">
    <header class="flex items-center bg-pink-200 h-20 lg:h-40 shadow-2xl">
        <h2 class="w-full text-lg text-pink-900 lg:text-4xl font-black flex justify-center capitalize lg:font-extrabold"> Welcome to your Online Library </h2>
    </header>
    ...
    <main>
        <div
            ...
            <span className="justify-center text-sm text-center text-gray-500 flex-items-center dark:text-gray-400">
                ...
                <a href="#" target="_blank" className="text-sm text-blue-500 underline hover:text-blue-700 ml-2">
                    Sign in
                </a>
            </span>
        ...
        <div
            className="flex flex-col justify-center items-center mx-auto w-full md:w-2/3 px-4 py-8 bg-white shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10 mt-10">
            <div
                className="self-center mb-2 text-xl font-light font-bold text-gray-800 sm:text-2xl dark:text-white">
                Create a new account
            </div>
